        ...
        <PageContainer backgroundImage="/images/LKDV_website_layout_1_57PM.jpeg">
            ...
            <Container maxWidth="lg" sx={{ mb: 6 }}>
                <Card sx={{ 
                    ...
                    <CardContent sx={{ p: 4 }}>
                        <Typography variant="h4" component="h2" sx={{ fontWeight: 700, mb: 2, color: 'white', textShadow: '1px 1px 2px rgba(0,0,0,0.3)' }}>
                            The 10% That Succeed
                        </Typography>
                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={12} md={6} lg={3}>
                                <Card sx={{ 
                                    ...
                                    <CardContent>
                                        <Typography variant="h6" sx={{ fontWeight: 700, color: 'primary.main' }}>Language Depth</Typography>
                            ...
                            <Grid item xs={12} md={6} lg={3}>
                                <Card sx={{ 
                                    ...
                                    <CardContent>
                                        <Typography variant="h6" sx={{ fontWeight: 700, color: 'primary.main' }}>Local Integration</Typography>
                            ...
                            <Grid item xs={12} md={6} lg={3}>
                                <Card sx={{ 
                                    ...
                                    <CardContent>
                                        <Typography variant="h6" sx={{ fontWeight: 700, color: 'primary.main' }}>Compliance Specialization</Typography>
            ...
            <Container maxWidth="lg" sx={{ mb: 6 }}>
                <Card sx={{ backgroundColor: 'rgba(255,255,255,0.95)', boxShadow: 3 }}>
                    <CardContent sx={{ p: 4 }}>
                        ...
                        <Grid container spacing={2}>
                            <Grid item xs={12} md={4}>
                                <Card sx={{ backgroundColor: 'rgba(255,255,255,0.95)', boxShadow: 1 }}>
                                    <CardContent sx={{ textAlign: 'center' }}>
                                        <Typography variant="h2" color="secondary" sx={{ fontWeight: 700 }}>37.6%</Typography>
                            ...
                            <Grid item xs={12} md={4}>
                                <Card sx={{ backgroundColor: 'rgba(255,255,255,0.95)', boxShadow: 1 }}>
                                    <CardContent sx={{ textAlign: 'center' }}>
                                        <Typography variant="h2" color="secondary" sx={{ fontWeight: 700 }}>€2.86B</Typography>
                            ...
                            <Grid item xs={12} md={4}>
                                <Card sx={{ backgroundColor: 'rgba(255,255,255,0.95)', boxShadow: 1 }}>
                                    <CardContent sx={{ textAlign: 'center' }}>
                                        <Typography variant="h2" color="secondary" sx={{ fontWeight: 700 }}>~70%</Typography>
